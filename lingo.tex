...
\PFS{language clarified below} 
\end{minipage}}

We make \PFS{the} assumption \PFS{that} paralogous cognates inherit both
their phonological form and their meaning from a common
ancestor. \PFS{Paralogy is a concept diffent from polysemy: paralogous
...
\PFS{(but not equality)} of meaning and phonological form, if not

...
analysis used only the core concepts \PFS{included in word lists} \TODO{add
  a few references to word lists here?} \NR{\cite{IDS,Starostin:11,Wichmann:10,Swadesh:71}}
...
\cite{Lee:11,Gray:09,Dunn:11,Gell-Mann:11}, and provided a credible starting point in
...
achieve reasonably good rates of classification \cite{List:17}. Any
...
imperfect proxy for syllable \NEW{boundaries}.
...
\PFS{PFS will try draft something ...} 
...
\TODO{ This idea is limited by regularities in the meaning space of the
  kind discussed in 4.1-4.2 (as well as synonyms). The paper would make an
  actual contribution if this was taken seriously for a correct assessment
  of number emanating from a permutation test. TANMOY: do you know know
  what could be meant here?}

RELPY LETTER ONLY: THIS NEEDS ANALYSIS BEYOND THE SCOPE OF THE PAPER.  THE
IDEA IS TO USE MEANING SIMILARITIES \emph{DISCUSSED IN 4.1-2} TO DO THE
PERMUTATION TEST.
\end{minipage}}

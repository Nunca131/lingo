...
languages~\cite{dUrville:1832}. 
\TODO{In the cited paper Dumont d'Urville talks about the distribution of
different
...
relationships.
\TODO{The logic here seems strange wrt to the use of infallible. Is an
infallible method one that retrieves true conclusions from wrong data?}
An extreme example in the phylogeny of animals is the
...
vertical nor completely tree-like. 
\TODO{Says the same thing twice.}
Even in higher organisms, horizontal
...
data. 
\TODO{What is lineage sorting?}
Lineages are not always well-separated, as in the case of \TT{ring
...
\TODO{This is a circular assessment (trees are useful when the data is
sufficiently tree-like).
...
wide spread in the posterior distributions in Bayesian settings. 
...
linguistic data for the reconstruction of language history. 
\TODO{Several? There have been hundreds. Perhaps the author mean papers with
...
cited papers.}
One must note, however, that even
...
\TODO{I would not be so sure it's theoretically justified in cases where you have
...
\TODO{The text and formulas here are ambiguous as to whether sigma and nscore

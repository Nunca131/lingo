...
traditional historical linguists, \TB{their real value is in
  situations where the evidence is scarce or constradictory.  In such
  cases, the results of the analysis depend on prior beliefs and
  assumptions about consistncy with global patterns.  Whereas a
...
\NR{Nakh-Daghestanian} languages (mostly form the Daghestanian branch, 

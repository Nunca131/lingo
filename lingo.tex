...
to infer sound changes rules directly from a scoring system. 
\TODO{At least cite Holman & Wichmann's paper in Language for the discussion
...
literature, we elaborate on the example in Fig.~\ref{fig:permut}. 
\TODO{I am surprised to learn it is underappreciated. It's been all over the
...
\TODO{This conclusion should be qualified by the fact that only closely related
...
We described in the previous sections several statistical \NEW{methods} and

...
An important issue to consider in the choice of traits to analyze is
  ...
  method is infallible \NEW{with respest to the features chosen}. If
  \NEW{these} are either too noisy to convey retrievable information or are
  not strictly vertically transmitted to begin with the resulting tree
  might not depict the actual relationships. An extreme example in the

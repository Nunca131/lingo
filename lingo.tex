...
All \GS{the} word list\GS{s} are kept in the same format, and the organization is based on
...
have potentially 22 chapters and in total 1310 potential entries\GS{(or more,
since multiple synonyms are allowed for a single term if it is difficult
to elicit one perfect equivalent for the general meaning of the entry)}. Entries
...
\GS{although some support for the idea of a constant rate of a change within 
...
Otherwise: do you know who wrote this? \GS{This is problematic, because research 
